...
if (isset($_POST['add_product'])) {
   ...
   $queryGetLastitemId = "SELECT  MAX(item_id) as ItemId
        FROM Items";
        $runQueryLastitemId = mysqli_query($con,$queryGetLastitemId);
        $rowitemId = mysqli_fetch_assoc($runQueryLastitemId);
        $lastitemId = $rowitemId['ItemId'];
         $newitemId=$lastitemId+1;

   $queryAddProduct = "INSERT INTO Items (item_id,item_name,item_price,stall_id,item_quantity,item_url) VALUES ('$newitemId','$name','$price','$stall','$quantity','$url')";
...
<header class="header">
      ...
      <section class="flex">
         ...
         <a href="dashboard.php" class="logo">JIIT<span>CAFE</span></a>
   ...
   <section class="show-products" style="padding-top: 0;">
      ...
      <div class="box-container">
         ...
         <div class="flex">
            ...
            <div class="category">'.$stall_name.'</div>
